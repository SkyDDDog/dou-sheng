...
type DouyinPublishListResponse struct {
	...
	VideoList  []*VideoResponse `protobuf:"bytes,3,rep,name=video_list,json=videoList,proto3" json:"video_list,omitempty"`     // 用户发布的视频列表
}
...
func (x *DouyinPublishListResponse) GetVideoList() []*VideoResponse {
	if x != nil {
		return x.VideoList
	}
	return nil
...
type DouyinFeedResponse struct {
	...
	StatusCode int32            `protobuf:"varint,1,opt,name=status_code,json=statusCode,proto3" json:"status_code,omitempty"` // 状态码, 0-成功, 其他值-失败
	StatusMsg  string           `protobuf:"bytes,2,opt,name=status_msg,json=statusMsg,proto3" json:"status_msg,omitempty"`     // 返回状态描述
	VideoList  []*VideoResponse `protobuf:"bytes,3,rep,name=video_list,json=videoList,proto3" json:"video_list,omitempty"`     // 视频列表
...
func (x *DouyinFeedResponse) GetVideoList() []*VideoResponse {
	if x != nil {
		return x.VideoList
	}
	return nil
...
type VideoResponse struct {
	...
	Author        *UserResponse `protobuf:"bytes,2,opt,name=author,proto3" json:"author,omitempty"`                                     // 视频作者信息
...
func (x *VideoResponse) GetAuthor() *UserResponse {
	if x != nil {
		return x.Author
	}
	return nil
...
func (x *VideoResponse) GetPlayUrl() string {
	if x != nil {
		return x.PlayUrl
	}
	return ""
...
func (x *VideoResponse) GetCoverUrl() string {
	if x != nil {
		return x.CoverUrl
	}
	return ""
...
func (x *VideoResponse) GetCommentCount() int64 {
	if x != nil {
...
func (x *VideoResponse) GetIsFavorite() bool {
	if x != nil {
		return x.IsFavorite
	}
	return false
...
var file_videoService_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x02, 0x70, 0x62, 0x22, 0x78, 0x0a, 0x1d, 0x64, 0x6f, 0x75, 0x79,
	...
	0x49, 0x64, 0x22, 0x7b, 0x0a, 0x1e, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x5f, 0x70, 0x75, 0x62,
	...
	0x73, 0x4d, 0x73, 0x67, 0x12, 0x19, 0x0a, 0x08, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x5f, 0x69, 0x64,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x90, 0x01,
	...
	0x28, 0x0b, 0x32, 0x11, 0x2e, 0x70, 0x62, 0x2e, 0x56, 0x69, 0x64, 0x65, 0x6f, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x52, 0x09, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x4c, 0x69, 0x73, 0x74,
	...
	0x61, 0x74, 0x75, 0x73, 0x4d, 0x73, 0x67, 0x12, 0x30, 0x0a, 0x0a, 0x76, 0x69, 0x64, 0x65, 0x6f,
	0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x70, 0x62,
	0x2e, 0x56, 0x69, 0x64, 0x65, 0x6f, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x52, 0x09,
	...
	0x78, 0x74, 0x54, 0x69, 0x6d, 0x65, 0x22, 0x84, 0x02, 0x0a, 0x0d, 0x56, 0x69, 0x64, 0x65, 0x6f,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x12, 0x28, 0x0a, 0x06, 0x61, 0x75, 0x74, 0x68,
	0x6f, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x70, 0x62, 0x2e, 0x55, 0x73,
	0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x52, 0x06, 0x61, 0x75, 0x74, 0x68,
	...
	0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x22, 0x99, 0x01,
	...
	0x08, 0x69, 0x73, 0x46, 0x6f, 0x6c, 0x6c, 0x6f, 0x77, 0x32, 0xf4, 0x01, 0x0a, 0x0c, 0x56, 0x69,
...
var file_videoService_proto_goTypes = []interface{}{
	...
	(*VideoResponse)(nil),               // 6: pb.VideoResponse
	(*UserResponse)(nil),                // 7: pb.UserResponse
}
var file_videoService_proto_depIdxs = []int32{
	6, // 0: pb.douyin_publish_list_response.video_list:type_name -> pb.VideoResponse
	6, // 1: pb.douyin_feed_response.video_list:type_name -> pb.VideoResponse
	7, // 2: pb.VideoResponse.author:type_name -> pb.UserResponse
	0, // 3: pb.VideoService.ActionVideo:input_type -> pb.douyin_publish_action_request
	2, // 4: pb.VideoService.VideoList:input_type -> pb.douyin_publish_list_request
	4, // 5: pb.VideoService.VideoFeed:input_type -> pb.douyin_feed_request
