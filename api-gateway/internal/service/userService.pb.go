...
var file_userService_proto_rawDesc = []byte{
	...
	0x72, 0x32, 0xed, 0x01, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
...
var file_userService_proto_depIdxs = []int32{
	...
	3, // 4: pb.UserService.UserLogin:output_type -> pb.douyin_user_login_response
	1, // 5: pb.UserService.UserRegister:output_type -> pb.douyin_user_register_response
	5, // 6: pb.UserService.UserShow:output_type -> pb.douyin_user_response
