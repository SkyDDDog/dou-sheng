...
func (x *Message) Reset() {
	*x = Message{}
	if protoimpl.UnsafeEnabled {
		mi := &file_messageModels_proto_msgTypes[0]
...
func (*Message) Descriptor() ([]byte, []int) {
	return file_messageModels_proto_rawDescGZIP(), []int{0}
}
...
var File_messageModels_proto protoreflect.FileDescriptor

var file_messageModels_proto_rawDesc = []byte{
	0x0a, 0x13, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x4d, 0x6f, 0x64, 0x65, 0x6c, 0x73, 0x2e,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x02, 0x70, 0x62, 0x22, 0x94, 0x01, 0x0a, 0x07, 0x4d, 0x65,
...
var (
	file_messageModels_proto_rawDescOnce sync.Once
	file_messageModels_proto_rawDescData = file_messageModels_proto_rawDesc
)

func file_messageModels_proto_rawDescGZIP() []byte {
	file_messageModels_proto_rawDescOnce.Do(func() {
		file_messageModels_proto_rawDescData = protoimpl.X.CompressGZIP(file_messageModels_proto_rawDescData)
	})
	return file_messageModels_proto_rawDescData
}

var file_messageModels_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_messageModels_proto_goTypes = []interface{}{
	(*Message)(nil), // 0: pb.Message
}
var file_messageModels_proto_depIdxs = []int32{
...
func init() { file_messageModels_proto_init() }
func file_messageModels_proto_init() {
	if File_messageModels_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_messageModels_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_messageModels_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_messageModels_proto_goTypes,
		DependencyIndexes: file_messageModels_proto_depIdxs,
		MessageInfos:      file_messageModels_proto_msgTypes,
	}.Build()
	File_messageModels_proto = out.File
	file_messageModels_proto_rawDesc = nil
	file_messageModels_proto_goTypes = nil
	file_messageModels_proto_depIdxs = nil
}
