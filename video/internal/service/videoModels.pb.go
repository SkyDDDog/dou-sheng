...
func (x *VideoId_Request) Reset() {
	*x = VideoId_Request{}
	if protoimpl.UnsafeEnabled {
		mi := &file_videoModels_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *VideoId_Request) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VideoId_Request) ProtoMessage() {}

func (x *VideoId_Request) ProtoReflect() protoreflect.Message {
	mi := &file_videoModels_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VideoId_Request.ProtoReflect.Descriptor instead.
func (*VideoId_Request) Descriptor() ([]byte, []int) {
	return file_videoModels_proto_rawDescGZIP(), []int{1}
}

func (x *VideoId_Request) GetVideoId() int64 {
	if x != nil {
		return x.VideoId
	}
	return 0
...
func (x *VideoId_Request) GetRequesterId() int64 {
	if x != nil {
...
var file_videoModels_proto_rawDesc = []byte{
	...
	0x65, 0x6c, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xf4, 0x01, 0x0a, 0x05, 0x56, 0x69,
	...
	0x22, 0x4f, 0x0a, 0x0f, 0x56, 0x69, 0x64, 0x65, 0x6f, 0x49, 0x64, 0x5f, 0x52, 0x65, 0x71, 0x75,
...
var file_videoModels_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_videoModels_proto_goTypes = []interface{}{
	(*Video)(nil),           // 0: pb.Video
	(*VideoId_Request)(nil), // 1: pb.VideoId_Request
	(*User)(nil),            // 2: pb.User
}
var file_videoModels_proto_depIdxs = []int32{
	2, // 0: pb.Video.author:type_name -> pb.User
...
func file_videoModels_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_videoModels_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*VideoId_Request); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
